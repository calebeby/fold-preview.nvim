...
function M.setup(config)
	...
	if type(config.border) == "string" then
		...
		elseif vim.tbl_contains({ "single", "double", "rounded", "solid" }, config.border) then
...
function M.show_preview()
	...
	api.nvim_create_autocmd("WinScrolled", {
		...
		callback = function()
			...
			api.nvim_win_set_height(winid, fold_size < room_below and fold_size or room_below)
		end,
	})
	...
	api.nvim_create_autocmd("VimResized", {
		...
		callback = function()
			...
			api.nvim_win_set_width(winid, max_line_len < room_right and max_line_len or room_right)
		end,
	})
